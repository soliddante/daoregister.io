<x-layouts.app>
    <div class=" fixed top-[64px] right-0 w-screen  h-screen bg-black bg-opacity-40 z-40">
            ...
            <section class="mt-4">
                ...
                <section id="mode_2" class="hidden">
                    <div class="w-full mx-auto">
                        ...
                        <button type="button"
                            class="jsc_wc_disconnect mt-4 w-full items-center text-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Reconnect</button>
                    </div>
                </section>
