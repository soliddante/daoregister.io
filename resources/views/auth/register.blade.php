<x-layouts.app_full>
    ...
    <nav class="mx-auto sm:w-[600px]">
        <h1 class="order-1 text-gray-900 text-3xl font-extrabold tracking-tight mt-2">Registration</h1>
    </nav>

    <form action="{{ route('register_store') }}" class="jsc_register mx-auto sm:w-[600px]">
        <div class="min-h-full px-2 bg-white rounded-md border my-4 py-4">
                ...
                <article>
                    ...
                    <div class="mt-2 grid grid-cols-2 gap-y-6 gap-x-4 sm:grid-cols-6">
                        <div class="sm:col-span-3">
                            ...
                            <div class="mt-1">
                                <input type="text" name="firstname" value="{{ old('firstname') ?? '' }}" value="{{ old('firstname') ?? '' }}" id="first-name" autocomplete="given-name"
                        ...
                        <div class="sm:col-span-3">
                            ...
                            <div class="mt-1">
                                <input type="text" name="lastname" value="{{ old('lastname') ?? '' }}" id="last_name" autocomplete="family-name"
                                    class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md">
                            </div>
                        </div>
                        ...
                        <div class="sm:col-span-6 col-span-2">
                            ...
                            <div class="mt-1">
                                <input type="date" name="birthday" value="{{ old('birthday') ?? '' }}" id="birthday" autocomplete="family-name"
                                    class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md">
                            </div>
                        </div>
                                ...
                                <div class="flex justify-between lg:justify-start lg:gap-8 ">
                                    ...
                                    <div class="flex gap-4">
                                        <div class="flex items-center">
                                            <input id="man" value="man" name="gendar" value="{{ old('gendar') ?? '' }}" type="radio" class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300">
                                            <label for="man" class="ml-1 block text-sm font-medium text-gray-700"> Man </label>
                                        </div>
                                        <div class="flex items-center">
                                            <input id="woman" value="woman" name="gendar" value="{{ old('gendar') ?? '' }}" type="radio" class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300">
                ...
                <article>
                    ...
                    <div class="mt-2 grid grid-cols-2 gap-y-6 gap-x-4 sm:grid-cols-6">
                        <div class="sm:col-span-3">
                            ...
                            <div class="mt-1">
                                <select name="country" value="{{ old('country') ?? '' }}" autocomplete="given-name" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md">
                        ...
                        <div class="sm:col-span-3">
                            ...
                            <div class="mt-1">
                                <select name="city" value="{{ old('city') ?? '' }}" autocomplete="given-name" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md">
                        ...
                        <div class="sm:col-span-6 col-span-2">
                            ...
                            <div class="mt-1">
                                <textarea name="address" autocomplete="given-name" class=" h-32 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md">{{ old('address') ?? '' }}</textarea>
                            </div>
                        </div>
                    </div>
                </article>
                ...
                <article>
                    ...
                    <div class="mt-2 grid grid-cols-2 gap-y-6 gap-x-4 sm:grid-cols-6">
                        <div class="sm:col-span-3">
                            ...
                            <div class="mt-1">
                                <select name="language_first" value="{{ old('language_first') ?? '' }}" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md">
                        ...
                        <div class="sm:col-span-3">
                            ...
                            <div class="mt-1">
                                <select name="language_second" value="{{ old('language_second') ?? '' }}" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md">
                        ...
                        <div class="sm:col-span-3 col-span-2">
                            ...
                            <div class="mt-1">
                                <select name="security_question" value="{{ old('security_question') ?? '' }}" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md">
                        ...
                        <div class="sm:col-span-3 col-span-2">
                            ...
                            <div class="mt-1">
                                <input type="text" name="security_answer" value="{{ old('security_answer') ?? '' }}" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md">
                            </div>
                        </div>
                    </div>
