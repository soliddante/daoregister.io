        ...
        <section class="flex  justify-between  flex-col">
            ...
            <div class="mt-4">
                <div class="flex justify-between items-center">
                    ...
                    <div>
                        <button type="button"
                            class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md shadow-sm text-white bg-theme-600 hover:bg-theme-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-theme-500">Add
                            funds</button>
                    </div>
                </div>
            </div>
...
<div class="px-6">
    ...
    <section id="mode_0" class="hidden">
        <div class="w-full mx-auto">
            ...
            <button type="button"
                class="jsc_update_wallet mt-4 w-full items-center text-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-theme-600 hover:bg-theme-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-theme-500">Submit
                Wallet</button>
        </div>
    </section>
    ...
    <section id="mode_1" class="hidden">
        <div class="w-full mx-auto">
            ...
            <button type="button"
                class="jsc_wc_connect mt-4 w-full items-center text-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-theme-600 hover:bg-theme-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-theme-500">Sync
                my
                Wallet</button>
        </div>
            ...
            <div class="rounded-md bg-yellow-50 p-4">
                <div class="flex">
                    ...
                    <div class="ml-3">
                        ...
                        <button type="button"
                            class="jsc_wc_disconnect mt-4 w-full items-center text-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-theme-600 hover:bg-theme-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-theme-500">Disconnect
                        </button>
                    </div>
