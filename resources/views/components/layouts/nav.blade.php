                ...
                <div class="hidden md:ml-6 md:flex md:space-x-8">
                    ...
                    @if (auth()->user()->type == 1)
                        <a href="{{ route('create_dao') }}"
                            class=" {{ Route::is('create_dao') ? 'border-indigo-500' : 'border-transparent' }} text-gray-500 hover:border-gray-300 hover:text-gray-700 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">
                            Generate
                            Dao </a>
                    @else
                        <div
