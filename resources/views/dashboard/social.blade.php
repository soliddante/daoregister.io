        ...
        <article>
            ...
            <div class="mt-2 grid grid-cols-2  gap-x-4 ">
                <div class="mt-3 flex rounded-md shadow-sm col-span-2 sm:col-span-1">
                    ...
                    <input type="text" name="instagram" placeholder="{{ auth()->user()->instagram }}" class="flex-1 min-w-0 text-sm block w-full px-3 py-2 rounded-none rounded-r-md focus:ring-theme-500 focus:border-theme-500 sm:text-sm border-gray-300">
                </div>
                <div class="mt-3 flex rounded-md shadow-sm col-span-2 sm:col-span-1">
                    ...
                    <input type="text" name="Twitter" placeholder="{{ auth()->user()->Twitter }}" class="flex-1 min-w-0 text-sm block w-full px-3 py-2 rounded-none rounded-r-md focus:ring-theme-500 focus:border-theme-500 sm:text-sm border-gray-300">
                </div>
                <div class="mt-3 flex rounded-md shadow-sm col-span-2 sm:col-span-1">
                    ...
                    <input type="text" name="Facebook" placeholder="{{ auth()->user()->Facebook }}" class="flex-1 min-w-0 text-sm block w-full px-3 py-2 rounded-none rounded-r-md focus:ring-theme-500 focus:border-theme-500 sm:text-sm border-gray-300">
                </div>
                <div class="mt-3 flex rounded-md shadow-sm col-span-2 sm:col-span-1">
                    ...
                    <input type="text" name="Whatsapp" placeholder="{{ auth()->user()->Whatsapp }}" class="flex-1 min-w-0 text-sm block w-full px-3 py-2 rounded-none rounded-r-md focus:ring-theme-500 focus:border-theme-500 sm:text-sm border-gray-300">
                </div>
                <div class="mt-3 flex rounded-md shadow-sm col-span-2 sm:col-span-1">
                    ...
                    <input type="text" name="Telegram" placeholder="{{ auth()->user()->Telegram }}" class="flex-1 min-w-0 text-sm block w-full px-3 py-2 rounded-none rounded-r-md focus:ring-theme-500 focus:border-theme-500 sm:text-sm border-gray-300">
                </div>
                <div class="mt-3 flex rounded-md shadow-sm col-span-2 sm:col-span-1">
                    ...
                    <input type="text" name="linkedin" placeholder="{{ auth()->user()->linkedin }}" class="flex-1 min-w-0 text-sm block w-full px-3 py-2 rounded-none rounded-r-md focus:ring-theme-500 focus:border-theme-500 sm:text-sm border-gray-300">
                </div>
            </div>
        </article>
        {{-- /*********
