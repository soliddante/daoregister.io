<x-layouts.app>
    ...
    <section class="lg:max-w-5xl lg:px-0 px-2 mx-auto pb-32">
        <header class="container max-width-xs margin-bottom-lg">
            <div class="text-component text-center line-height-lg v-space-md margin-bottom-md">
                <h1 class="lg:text-5xl text-3xl my-12 mt-36 font-black">Terms and Conditions</h1>
            </div>
        </header>
        <div class="container max-width-adaptive-sm">
            <div class="text-component line-height-lg v-space-md">
                <p>
                    ...
                    of madewithtailwindcss.com's Website, located at
                    madewithtailwindcss.com.
                </p>
                <p>
                    By accessing this website we assume you accept these terms and
                    conditions. Do not continue to use madewithtailwindcss.com if you do not
                ...
                <h3>
                    <strong class="text-2xl font-black block pb-2 pt-8"> Cookies</strong>
                </h3>
                <p>
                    We employ the use of cookies. By accessing madewithtailwindcss.com, you
                    agreed to use cookies in agreement with the madewithtailwindcss.com's
                    Privacy Policy.
                </p>
                <p>
                ...
                <h3>
                    <strong class="text-2xl font-black block pb-2 pt-8"> License</strong>
                </h3>
                <p>
                    Unless otherwise stated, madewithtailwindcss.com and/or its licensors
                    own the intellectual property rights for all material on
                    madewithtailwindcss.com. All intellectual property rights are reserved.
                    You may access this from madewithtailwindcss.com for your own personal
                    use subjected to restrictions set in these terms and conditions.
                </p>
                <p>You must not:</p>
                <ul>
                    <li>Republish material from madewithtailwindcss.com</li>
                    <li>Sell, rent or sub-license material from madewithtailwindcss.com</li>
                    <li>
                        Reproduce, duplicate or copy material from madewithtailwindcss.com
                    </li>
                    <li>Redistribute content from madewithtailwindcss.com</li>
                </ul>
                <p>This Agreement shall begin on the date hereof.</p>
                <p>
                    Parts of this website offer an opportunity for users to post and
                    exchange opinions and information in certain areas of the website.
                    madewithtailwindcss.com does not filter, edit, publish or review
                    Comments prior to their presence on the website. Comments do not reflect
                    the views and opinions of madewithtailwindcss.com,its agents and/or
                ...
                <p>
                    madewithtailwindcss.com reserves the right to monitor all Comments and
                ...
                <p>
                    You hereby grant madewithtailwindcss.com a non-exclusive license to use,
                    reproduce, edit and authorize others to use, reproduce and edit any of
                    your Comments in any and all forms, formats or media.
                </p>
                <h3>
                    <strong class="text-2xl font-black block pb-2 pt-8"> Hyperlinking to our Content</strong>
                </h3>
                <p>
                ...
                <p>
                    ...
                    the hyperlink compensates the absence of madewithtailwindcss.com; and
                ...
                <p>
                    ...
                    e-mail to madewithtailwindcss.com. Please include your name, your
                ...
                <p>
                    No use of madewithtailwindcss.com's logo or other artwork will be
                    allowed for linking absent a trademark license agreement.
                </p>
                <h3>
                    <strong class="text-2xl font-black block pb-2 pt-8"> iFrames</strong>
                </h3>
                <p>
                ...
                <h3>
                    <strong class="text-2xl font-black block pb-2 pt-8"> Content Liability</strong>
                </h3>
                <p>
                ...
                <h3>
                    <strong class="text-2xl font-black block pb-2 pt-8"> Your Privacy</strong>
                </h3>
                <p>Please read Privacy Policy</p>
                <h3>
                    <strong class="text-2xl font-black block pb-2 pt-8"> Reservation of Rights</strong>
                </h3>
                <p>
                ...
                <h3>
                    <strong class="text-2xl font-black block pb-2 pt-8"> Removal of links from our website</strong>
                </h3>
                <p>
                ...
                <h3>
                    <strong class="text-2xl font-black block pb-2 pt-8"> Disclaimer</strong>
                </h3>
                <p>
